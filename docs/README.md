...
This upstream overview is retained by Graphix with contribution links updated
for the independent fork.
...
Graphix bugs and contributions belong in the
[Graphix repository](https://github.com/Chevalier12/Graphix), not upstream SDL.
